...
app = Flask(__name__)
app.config[
    'SQLALCHEMY_DATABASE_URI'] = 'postgresql://wkjvumxnirhcbx:046c40445f3e128229090cb1b25f84769559e8dd215a1ac9b13137af47812ea9@ec2-34-206-148-196.compute-1.amazonaws.com:5432/dfsi1fcrvq2qaa'
CORS(app)
db = SQLAlchemy(app)
